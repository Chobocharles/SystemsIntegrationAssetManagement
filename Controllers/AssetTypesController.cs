...
namespace Asset_Management.Controllers
{
    public class AssetTypesController : Controller
    {
        ...
        public AssetTypesController(AssetContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("AssetTypeId,AssetType1")] AssetType assetType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AssetTypeId,AssetType1")] AssetType assetType)
        {
